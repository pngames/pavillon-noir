...
namespace opal
{
	...
	void Simulator::setPostStepEventHandler(
		PostStepEventHandler* eventHandler)
	{
		mPostStepEventHandler = eventHandler;
	}

	PostStepEventHandler* Simulator::getPostStepEventHandler()const
	{
		return mPostStepEventHandler;
	}
