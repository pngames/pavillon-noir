...
PNEventManager::PNEventManager()
{
  ...
  _eventNames[PN_EVENT_GAME_DEATH] = "PN_EVENT_GAME_DEATH";
  _eventEnums["PN_EVENT_GAME_DEATH"] = PN_EVENT_GAME_DEATH;
  _eventNames[PN_EVENT_GAME_OVER] = "PN_EVENT_GAME_OVER";
  _eventEnums["PN_EVENT_GAME_OVER"] = PN_EVENT_GAME_OVER;
  ...
  _eventEnums["PN_EVENT_GAME_LIFEVAL"] = PN_EVENT_GAME_LIFEVAL;
  _eventNames[PN_EVENT_GAME_LIFEVAL] = "PN_EVENT_GAME_LIFEVAL";
