...
PNEventManager::PNEventManager()
{
  ...
  // GUI
  _eventEnums["PN_EVENT_GUI_MENUROOT"] = PN_EVENT_GUI_MENUROOT;
  _eventNames[PN_EVENT_GUI_MENUROOT] = "PN_EVENT_GUI_MENUROOT";
  _eventEnums["PN_EVENT_GUI_LOAD"] = PN_EVENT_GUI_LOAD;
  _eventNames[PN_EVENT_GUI_LOAD] = "PN_EVENT_GUI_LOAD";
  _eventEnums["PN_EVENT_GUI_OPTIONS"] = PN_EVENT_GUI_OPTIONS;
  _eventNames[PN_EVENT_GUI_OPTIONS] = "PN_EVENT_GUI_OPTIONS";
  _eventEnums["PN_EVENT_GUI_CREDITS"] = PN_EVENT_GUI_CREDITS;
  _eventNames[PN_EVENT_GUI_CREDITS] = "PN_EVENT_GUI_CREDITS";
  _eventEnums["PN_EVENT_GUI_NEWGAME"] = PN_EVENT_GUI_NEWGAME;
  _eventNames[PN_EVENT_GUI_NEWGAME] = "PN_EVENT_GUI_NEWGAME";
  _eventEnums["PN_EVENT_GUI_LOADGAME"] = PN_EVENT_GUI_LOADGAME;
  _eventNames[PN_EVENT_GUI_LOADGAME] = "PN_EVENT_GUI_LOADGAME";
