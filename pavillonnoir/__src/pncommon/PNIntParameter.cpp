...
: PNInt(param), PNConfigurableParameter(NULL, PN_PARAMTYPE_INT, &_value, label, altText, editable)
{
...
: PNInt(param), PNConfigurableParameter(p, PN_PARAMTYPE_INT, &_value, label, altText, editable)
{
