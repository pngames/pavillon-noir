...
: PNBool(param), PNConfigurableParameter(NULL, PN_PARAMTYPE_BOOLEAN, &_value, label, altText, editable)
{ }
...
: PNBool(param), PNConfigurableParameter(p, PN_PARAMTYPE_BOOLEAN, &_value, label, altText, editable)
{ }
