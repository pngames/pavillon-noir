 ...
 */
pnint	IPNSerializable::unserialize(const boost::filesystem::path& file)
{
  if (!fs::exists(file))
 ...
 * @see			pnGetErrorString
 */
pnint	IPNSerializable::unserialize(istream& i)
{
...
* @see			pnGetErrorString
*/
pnint	IPNSerializable::unserialize()
{
  return PNEC_NOT_IMPLEMENTED;
}
 ...
 * @see			pnGetErrorString
 */
pnint	IPNSerializable::serialize(const boost::filesystem::path& file)
{
  if (fs::exists(file))
	if (fs::is_directory(file))
	  return PNEC_NOT_A_FILE;
 ...
 * @see			pnGetErrorString
 */
pnint	IPNSerializable::serialize(ostream& o)
{
  return PNEC_NOT_IMPLEMENTED;
}
...
* @see			pnGetErrorString
*/
pnint	IPNSerializable::serialize()
{
  return PNEC_NOT_IMPLEMENTED;
}
