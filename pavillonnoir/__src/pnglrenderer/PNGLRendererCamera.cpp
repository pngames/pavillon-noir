...
PNGLRendererCamera::PNGLRendererCamera() : _cfCallback(this, &PNGLRendererCamera::_cleanFrustrum), _ufCallback(this, &PNGLRendererCamera::_updateFOV)
{
...
void
PNGLRendererCamera::resizeGLWindow(pnfloat width, pnfloat height)
{
  _width = width;
  _height = height;
...
void
PNGLRendererCamera::_updateFOV(pnEventType type, PNObject* source, PNEventData* ed)
{
  setUpdateGLFov(false);
