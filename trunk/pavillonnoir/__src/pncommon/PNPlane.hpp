...
public:
  virtual pnbool		isSegmentIntersectPlane(const PNPoint3f& segOrigin, const PNPoint3f& segDestination, PNPoint3f& intersection);
  virtual pnbool		isRayIntersectPlane(const PNPoint3f& rayOrigin, const PNNormal3f & rayDirection, PNPoint3f& intersection);
  virtual pnbool		isEquals(const PNPlane & plane);
