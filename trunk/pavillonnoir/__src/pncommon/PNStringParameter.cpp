...
: PNConfigurableParameter(p, PN_PARAMTYPE_STRING, &_str, 
						  label, altText, editable)
{}

PNStringParameter::~PNStringParameter()
{}

//////////////////////////////////////////////////////////////////////////

const std::string&
PNStringParameter::getString()
{
  return _str;
}
