...
namespace RSSScreenSaver.UI
{
    ...
    public class ItemListView : IDisposable 
    {
        ...
        private RssItemCollection items = null;
        private int nbItems;
        ...
        public RssItem SelectedItem { get { return items[selectedIndex]; } }
        ...
        public ItemListView(/*string title, RssItemCollection items*/)//string title, IList<T> items)
        {
            
           
        }

        public void setItemList(string title, RssItemCollection items)
        {
            if (items == null)
            ...
            if (maxItemsToShow < nbItems)
                nbCouches = (nbItems / maxItemsToShow) + 1;
        }
