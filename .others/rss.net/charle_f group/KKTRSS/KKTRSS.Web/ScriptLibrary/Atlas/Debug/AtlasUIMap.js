...
VE_MapControl.tileUrlPrefixes=["http://tiles0.virtualearth.msn.com/tiles/","http://tiles1.virtualearth.msn.com/tiles/","http://tiles2.virtualearth.msn.com/tiles/","http://tiles3.virtualearth.msn.com/tiles/"];
...
VE_MapControl.FindControlByInput=function(input){var c=VE_MapControl.controlList;for(var i=0;i<c.length;i++){if(c[i].keyboard==input)return c[i];}return null;}
...
Web.UI.MapStyle = Web.Enum.create('Road', 'Aerial', 'Hybrid');
Web.UI.ActivationType = Web.Enum.create('None', 'Hover', 'Click');
Web.UI.VirtualEarthMap = function(associatedElement) {
    Web.UI.VirtualEarthMap.initializeBase(this, [associatedElement]);
    
    var _map;
    var _pushpinActivation = Web.UI.ActivationType.None;
    var _popupPositioningMode = Web.UI.PositioningMode.BottomLeft;
    var _pushpins;
    var _data;
    var _latitude;
    var _longitude;
    var _zoomLevel = 0;
    var _mapStyle = Web.UI.MapStyle.Road;
    var _width;
    var _height;
    ...
    this.get_pushpins = function() {
        if (_pushpins == null) {
            _pushpins = Web.Component.createCollection(this);
        }
        return _pushpins;
    }
