...
{
	/// <summary>
	/// Exception for "Command Syntax Error" server response.
	/// </summary>
	public class CommandSyntaxErrorException : NNTPException
	{
		...
		public CommandSyntaxErrorException(string message, string command):base(message)
		{
			Command = command;
		}
	}
