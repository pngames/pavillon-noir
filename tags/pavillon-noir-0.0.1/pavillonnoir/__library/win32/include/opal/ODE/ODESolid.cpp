...
namespace opal
{
	...
	void ODESolid::addShape(const ShapeData& data)
	{
		...
		switch(data.getType())
		{
			...
			case MESH_SHAPE:
			{
				...
				dMassSetSphere(&newMass, (dReal)data.material.density, 1);
				break;
			}
#endif
			default:
	...
	{
		if (opal::abs(mass.I[0] - mass.I[5]) > globals::OPAL_EPSILON 
			|| opal::abs(mass.I[5] - mass.I[10]) > globals::OPAL_EPSILON)
		{
			return true;
		}
		else
