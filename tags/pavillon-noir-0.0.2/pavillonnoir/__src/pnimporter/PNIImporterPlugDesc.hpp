/*
 * PNIImporterPlugDesc.hpp
 * 
 * Description :
 * PNIImporterPlugDesc declaration
 *
...
#ifndef _PNIImporterPLUGDESC_HPP_
# define _PNIImporterPLUGDESC_HPP_
...
class PNIModelImporter;
class PNIMaterialImporter;
class PNISkeletonImporter;
class PNIAnimationImporter;
...
#endif /*_PNIImporterPLUGDESC_HPP_*/
